...
var HoverOnTouch = function () {
  ...
  _createClass(HoverOnTouch, [{
    ...
    value: function mouseenterHoverontouch(e) {
      ...
      this.currentHoveredElement = _utils2.default.getClosest(e.target, '.hoverontouch');

      this.currentHoveredElement.gifs && _utils2.default.restartGifs(this.currentHoveredElement.gifs);
